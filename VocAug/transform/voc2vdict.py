...
class voc2vdict:
    ...
    def __call__(self, xml_file_path, image_file_path):
        """
        ...
        for object_element in all_object_elements:
            ...
            if object_class_name not in self.class_list:
                self.class_list.append(object_class_name)
            object_class_id = self.class_list.index(object_class_name)
